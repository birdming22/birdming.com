...
### Usage
    ...
    sudo virt-builder debian-10 --format qcow2 --size 20G -o debian-10.qcow2 --root-password password --hostname usp --timezone Asia/Taipei --firstboot-command "dpkg-reconfigure openssh-server"
